...
| finalize | Finalizar: cierre (commits, Evolution Logs, push, PR). Suite táctica: git-save-snapshot / invoke-commit, git-sync-remote, git-create-pr; emergencia git-tactical-retreat. | paths.actionsPath/finalize/ |
