...
| finalize | Finalizar: cierre del ciclo (commits, Evolution Logs, push, PR a master). Suite táctica: git-save-snapshot / invoke-commit, git-sync-remote, git-create-pr; emergencia git-tactical-retreat. |
